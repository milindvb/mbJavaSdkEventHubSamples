...
public class EventProcessorSample
{
    public static void main(String args[]) throws InterruptedException, ExecutionException
    {
    	...
    	String namespaceName = "mbevthub1";
    	String eventHubName = "evthub1";
    	String sasKeyName = "RootManageSharedAccessKey";
    	String sasKey = "g+1UEUEF7va06zrf9q1azJp";
    	String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=testorage1;AccountKey=fuy9ZKSEoOg+uwgmNSdaK1CQw==;EndpointSuffix=core.windows.net";
    	String storageContainerName = "blobs1";
    	String hostNamePrefix = "mb";
		...
		.thenAccept((unused) ->
		{
			...
			/*
                        try
			{
				System.out.println("commented reading");
                                System.in.read();
			}
			catch (Exception e)
			{
